...
<?php
 ...
 where s_usn= '".$usn."'   AND password ='".$password."'";
    ...
    <div class="frame">
      <div class="card">          
        <div class="profile">
          ...
          <p class="name" name="name" style="font-size: 20px">Name:<?php echo $row['s_name']  ?></p> 
          <p class="usn" name="usn"   style="font-size: 20px">USN: <?php echo $row['s_usn'] ?></p>
          <p class="name" style="font-size: 18px">BRANCH: <?php echo $row['s_branch'] ?></p>
          <p class="job">DOB: <?php  echo $row['s_dob'] ?></p>
          <p class="job">Phone number: <?php  echo $row['s_phno'] ?> </p>
        ...
        <div class="stats">
          <div class="box">
            ...
            <span class="parameter" style="font-size: 17px"
              > <?php echo $row['s_address'] ?></span
            >
          </div>

          <div class="box">
            <span: class="value" style="font-size: 30px">Proctor:</span>
            <span class="parameter" style="font-size: 17px">Ashok kumar</span>
          </div>
        </div>
